...
-- insert actor data
INSERT INTO actor(aID, fName, surname, nationality, gender) VALUES
...
(49, 'TimothÃ©e', 'Chalamet', 'American', 'Male'),
...
(56, 'CaitrÃ­ona', 'Balfe', 'Irish', 'Female'),
...
(66, 'DÃ³nall',  'Ã“ HÃ©alai', 'Irish', 'Male'),
(67, 'Saise', 'NÃ­ Chuinn', 'Irish', 'Female'),
...
INSERT INTO director(dID, dfName, dSurname) VALUES
(1, 'Jordan','Peele'),
(2, 'Alfred','Hitchcock'),
(3, 'Sidney','Lumet'),
(4, 'Martin', 'McDonagh'),
...
-- insert movie data
INSERT INTO movie(mID, title, relYear, category, runTime, studioName, description, rating) VALUES
...
(28, 'An CailÃ­n CiÃºin', 2022, 'PG-13', 94, ' ', 'RURAL IRELAND. 1981. A quiet, neglected girl is sent away from her dysfunctional family to live with foster parents for the summer. She blossoms in their care, but in this house where there are meant to be no secrets, she discovers one.', 8),
...
CREATE TABLE genres (
  ...
  CONSTRAINT Fk_movieID FOREIGN KEY (movieID) REFERENCES movie(mID)
);
...
CREATE TABLE directs(
  ...
  CONSTRAINT Fk_movieID FOREIGN KEY (movieID) REFERENCES movie(mID),
  CONSTRAINT Fk_movieID FOREIGN KEY (directorID) REFERENCES director(dID)
)

-- insert data into directs
INSERT INTO directs (movieID, directorID) VALUES
(1,4),
(2,2),
(3,3),
(4,12),
...
CREATE TABLE stars(
  ...
  CONSTRAINT Fk_smovieID FOREIGN KEY (movieID) REFERENCES movie(mID),
  CONSTRAINT Fk_sactorID FOREIGN KEY (actorID) REFERENCES actor(aID)
)

INSERT INTO stars(movieID, actorID) VALUES
(1,9),
(1,1),
(2,4),
(2,5),
